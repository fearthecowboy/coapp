namespace CoApp.Toolkit.Compression {
    ...
    public class Iso8859Dash1Encoding : Encoding {
        ...
        /// </summary>
        /// <returns> The number of bytes produced by encoding the specified characters. This class alwas returns the value of <paramref
        ///    name="count" /> . </returns>
        ...
        /// </summary>
        /// <returns> The number of characters produced by decoding the specified sequence of bytes. This class alwas returns the value of <paramref
        ///    name="count" /> . </returns>
        ...
        /// </summary>
        /// <returns> The maximum number of bytes produced by encoding the specified number of characters. This class alwas returns the value of <paramref
        ///    name="charCount" /> . </returns>
        ...
        /// </summary>
        /// <returns> The maximum number of characters produced by decoding the specified number of bytes. This class alwas returns the value of <paramref
        ///    name="byteCount" /> . </returns>
