...
namespace CoApp.Toolkit.Compression {
    ...
    ///    stream.</para> <para>Using this stream, applications can compress or decompress data via stream
    ///                     <c>Read</c>
    ///                     and
    ///                     <c>Write</c>
    ...
    ///                     , "DEFLATE
    ///                     Compressed Data Format Specification version 1.3.".</para> <para>This class is similar to
    ///                                                                                  <see cref="ZlibStream" />
    ///                                                                                  , except that
    ///                                                                                  <c>ZlibStream</c>
    ///                                                                                  adds the
    ///                                                                                  <see href="http://www.ietf.org/rfc/rfc1950.txt">RFC
    ///                                                                                    1950 - ZLIB</see>
    ...
    public class DeflateStream : Stream {
        ...
        ///</summary>
        ///<remarks>
        ///  When mode is <c>CompressionMode.Compress</c> , the DeflateStream will use the default compression level. The "captive" stream will be closed when the DeflateStream is closed.
        ///</remarks>
        ///<example>
        ///  This example uses a DeflateStream to compress data from a file, and writes the compressed data to another file. <code>using (System.IO.Stream input = System.IO.File.OpenRead(fileToCompress))
        ///                                                                                                                    {
        ...
        ///<summary>
        ///  Create a <c>DeflateStream</c> using the specified <c>CompressionMode</c> , and explicitly specify whether the stream should be left open after Deflation or Inflation.
        ///</summary>
        ///<remarks>
        ...
        ///    parameter to leave the stream open.</para> <para>The
        ///                                                 <c>DeflateStream</c>
        ///                                                 will use the default compression level.</para> <para>See the other overloads of this constructor for example code.</para>
        ///</remarks>
        ...
        ///     <c>leaveOpen</c>
        ///     parameter
        ///     for more information.</para> <para>Application code won't call this code directly.  This method may be
        ...
        ///    <c>DeflateStream</c>
        ///    , and the data read
        ///    will be decompressed as you read.</para> <para>A
        ///                                               <c>DeflateStream</c>
        ///                                               can be used for
        ///                                               <c>Read()</c>
        ///                                               or
