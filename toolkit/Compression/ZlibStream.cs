...
namespace CoApp.Toolkit.Compression {
    ...
    ///                     <see href="http://www.ietf.org/rfc/rfc1950.txt">IETF RFC 1950</see>
    ///                     , "ZLIB Compressed
    ///                     Data Format Specification version 3.3". This implementation of ZLIB always uses
    ///                     DEFLATE as the compression method.  (see
    ///                     <see href="http://www.ietf.org/rfc/rfc1951.txt">IETF RFC 1951</see>
    ///                     , "DEFLATE
    ///                     Compressed Data Format Specification version 1.3.")</para> <para>The ZLIB format allows for varying compression methods, window sizes, and dictionaries.
    ///                                                                                  This implementation always uses the DEFLATE compression method, a preset dictionary,
    ///                                                                                  and 15 window bits by default.</para> <para>This class is similar to
    ...
    public class ZlibStream : Stream {
        ...
        ///</remarks>
        ///<example>
        ///  This example uses a <c>ZlibStream</c> to compress a file, and writes the compressed data to another file. <code>using (System.IO.Stream input = System.IO.File.OpenRead(fileToCompress))
        ///                                                                                                              {
        ...
        ///</remarks>
        ///<example>
        ///  This example uses a <c>ZlibStream</c> to compress data from a file, and writes the compressed data to another file. <code>using (System.IO.Stream input = System.IO.File.OpenRead(fileToCompress))
        ///                                                                                                                        {
        ///                                                                                                                        using (var raw = System.IO.File.Create(fileToCompress + ".zlib"))
        ///                                                                                                                        {
        ...
        ///<summary>
        ///  Create a <c>ZlibStream</c> using the specified <c>CompressionMode</c> , and explicitly specify whether the captive stream should be left open after Deflation or Inflation.
        ///</summary>
        ///<remarks>
        ///  <para>When mode is
        ///    <c>CompressionMode.Compress</c>
        ...
        ///    <c>ZlibStream</c>
        ///    will use
        ///    the default compression level.</para> <para>This constructor allows the application to request that the captive stream
        ...
        ///                                            open.</para> <para>See the other overloads of this constructor for example code.</para>
        ///</remarks>
        ...
        ///</summary>
        ///<remarks>
        ///  Setting this property always throws a <see cref="NotSupportedException" /> . Reading will return the total bytes written out, if used in writing, or the total bytes read in, if used in reading. The count may refer to compressed bytes or uncompressed bytes, depending on how you've used the stream.
        ///</remarks>
        ...
        ///    on that
        ///    <c>ZlibStream</c>
        ///    , and the data will be decompressed as it is read.</para> <para>A
        ///                                                                <c>ZlibStream</c>
        ///                                                                can be used for
        ///                                                                <c>Read()</c>
        ///                                                                or
        ...
        ///    will be the decompressed form of the data written.</para> <para>A
        ///                                                                <c>ZlibStream</c>
        ///                                                                can be used for
        ///                                                                <c>Read()</c>
        ///                                                                or
