...
namespace CoApp.Toolkit.Compression {
    ...
    ///    <c>GZipStream</c>
    ///    is a
    ///    <see href="http://en.wikipedia.org/wiki/Decorator_pattern">Decorator</see>
    ///    on a
    ///    <see cref="Stream" />
    ///    . It adds GZIP compression or decompression to any
    ///    stream.</para> <para>Like the
    ///                     <c>System.IO.Compression.GZipStream</c>
    ///                     in the .NET Base Class Library, the
    ///                     <c>Ionic.Zlib.GZipStream</c>
    ///                     can compress while writing, or decompress while
    ///                     reading, but not vice versa.  The compression method used is GZIP, which is
    ///                     documented in
    ///                     <see href="http://www.ietf.org/rfc/rfc1952.txt">IETF RFC
    ///                       1952</see>
    ///                     , "GZIP file format specification version 4.3".</para> <para>A
    ///                                                                              <c>GZipStream</c>
    ...
    ///                                                                              <c>Write()</c>
    ///                                                                              ), but not both.</para> <para>If you wish to use the
    ///                                                                                                        <c>GZipStream</c>
    ...
    ///                                                                                                        on the
    ///                                                                                                        <c>GZipStream</c>
    ///                                                                                                        .</para> <para>Though the GZIP format allows data from multiple files to be concatenated
    ///                                                                                                                   together, this stream handles only a single segment of GZIP format, typically
    ///                                                                                                                   representing a single file.</para> <para>This class is similar to
    ///                                                                                                                                                        <see cref="ZlibStream" />
    ///                                                                                                                                                        and
    ...
    ///                                                                                                                                                        <see cref="DeflateStream" />
    ///                                                                                                                                                        handles RFC1951-compliant streams. This class handles RFC1952-compliant streams.</para>
    ///</remarks>
    ...
    public class GZipStream : Stream {
        ...
        ///</summary>
        ///<remarks>
        ///  <para>The GZIP format allows for each file to optionally have an associated
        ...
        ///</summary>
        ///<remarks>
        ///  <para>The GZIP format optionally allows each file to have an associated
        ...
        ///    correctly with this code page.</para> <para>When decompressing (through
        ///                                            <c>Read()</c>
        ...
        ///</summary>
        ///<remarks>
        ///  GZIP allows the storage of a last modified time with each GZIP entry. When compressing data, you can set this before the first call to <c>Write()</c> . When decompressing, you can retrieve this value any time after the first call to <c>Read()</c> .
        ///</remarks>
        ...
        ///    <c>GZipStream</c>
        ///    will use the
        ///    default compression level.</para> <para>As noted in the class documentation, the
        ///                                        <c>CompressionMode</c>
        ///                                        (Compress
        ...
        ///</remarks>
        ///<example>
        ///  This example shows how to use a GZipStream to compress data. <code>using (System.IO.Stream input = System.IO.File.OpenRead(fileToCompress))
        ///                                                                 {
        ...
        ///                                                                 }
        ///                                                                 }
        ///                                                                 }</code> <code lang="VB">Dim outputFile As String = (fileToCompress &amp; ".compressed")
        ...
        ///</example>
        ///<example>
        ///  This example shows how to use a GZipStream to uncompress a file. <code>private void GunZipFile(string filename)
        ///                                                                     {
        ...
        ///                                                                     }
        ///                                                                     }
        ///                                                                     }</code> <code lang="VB">Private Sub GunZipFile(ByVal filename as String)
        ...
        ///</remarks>
        ///<example>
        ///  This example shows how to use a <c>GZipStream</c> to compress a file into a .gz file. <code>using (System.IO.Stream input = System.IO.File.OpenRead(fileToCompress))
        ///                                                                                          {
        ...
        ///<summary>
        ///  Create a <c>GZipStream</c> using the specified <c>CompressionMode</c> , and explicitly specify whether the stream should be left open after Deflation or Inflation.
        ///</summary>
        ///<remarks>
        ///  <para>This constructor allows the application to request that the captive stream
        ...
        ///    parameter to leave
        ///    the stream open.</para> <para>The
        ///                              <see cref="CompressionMode" />
        ...
        ///                                         .</para> <para>See the other overloads of this constructor for example code.</para>
        ///</remarks>
        ...
        ///<summary>
        ///  Create a <c>GZipStream</c> using the specified <c>CompressionMode</c> and the specified <c>CompressionLevel</c> , and explicitly specify whether the stream should be left open after Deflation or Inflation.
        ///</summary>
        ///<remarks>
        ///  <para>This constructor allows the application to request that the captive stream
        ///    remain open after the deflation or inflation occurs.  By default, after
        ...
        ///    <paramref name="leaveOpen" />
        ///    parameter to
        ///    leave the stream open.</para> <para>As noted in the class documentation, the
        ///                                    <c>CompressionMode</c>
        ///                                    (Compress
        ///                                    or Decompress) also establishes the "direction" of the stream.  A
        ///                                    <c>GZipStream</c>
        ...
        ///</remarks>
        ///<example>
        ///  This example shows how to use a <c>GZipStream</c> to compress data. <code>using (System.IO.Stream input = System.IO.File.OpenRead(fileToCompress))
        ///                                                                        {
        ///                                                                        using (var raw = System.IO.File.Create(outputFile))
        ///                                                                        {
        ...
        ///</summary>
        ///<remarks>
        ///  <para>The working buffer is used for all stream operations.  The default size is
        ///    1024 bytes.  The minimum size is 128 bytes. You may get better performance
        ///    with a larger buffer.  Then again, you might not.  You would have to test
        ///    it.</para> <para>Set this before the first call to
        ///                 <c>Read()</c>
        ///                 or
        ///                 <c>Write()</c>
        ///                 on the
        ...
        /// </summary>
        /// <remarks>
        ///   <para>This may or may not result in a
        ///     <c>Close()</c>
        ///     call on the captive
        ///     stream.  See the constructors that have a
        ///     <c>leaveOpen</c>
        ///     parameter
        ///     for more information.</para> <para>This method may be invoked in two distinct scenarios.  If disposing
        ...
        ///                                    be referenced or disposed.</para>
        /// </remarks>
        ...
        ///</summary>
        ///<remarks>
        ///  Setting this property always throws a <see cref="NotImplementedException" /> . Reading will return the total bytes written out, if used in writing, or the total bytes read in, if used in reading. The count may refer to compressed bytes or uncompressed bytes, depending on how you've used the stream.
        ///</remarks>
        ...
        ///</remarks>
        ///<example>
        ///  <code>byte[] working = new byte[WORKING_BUFFER_SIZE];
        ...
        ///    will be the compressed form of the data written.</para> <para>A
        ///                                                              <c>GZipStream</c>
        ///                                                              can be used for
        ///                                                              <c>Read()</c>
        ///                                                              or
        ///                                                              <c>Write()</c>
        ///                                                              , but not
        ///                                                              both. Writing implies compression.  Reading implies decompression.</para>
        ///</remarks>
        ...
        ///<seealso cref="GZipStream.CompressBuffer(byte[])" />
        ///<seealso cref="GZipStream.UncompressString(byte[])" />
        ///<param name="compressed"> A buffer containing data that has been compressed with GZip. </param>
