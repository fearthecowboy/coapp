...
namespace CoApp.Toolkit.Compression {
    ...
    public class CRC32 {
        ...
        /// </summary>
        /// <remarks>
        ///   <para>This method serves as an optimization for updating the CRC when a
        ...
        /// <remarks>
        ///   <para>In the CRC-32 used by BZip2, the bits are reversed. Therefore if you
        ///     want a CRC32 with compatibility with BZip2, you should pass true
        ///     here. In the CRC-32 used by GZIP and PKZIP, the bits are not
        ///     reversed; Therefore if you want a CRC32 with compatibility with
        ///     those, you should pass false.</para>
        /// </remarks>
        ...
        ///</summary>
        ///<param name='polynomial'> The polynomial to use for the CRC, expressed in the reversed (LSB) format: the highest ordered bit in the polynomial value is the coefficient of the 0th power; the second-highest order bit is the coefficient of the 1 power, and so on. Expressed this way, the polynomial for the CRC-32C used in IEEE 802.3, is 0xEDB88320. </param>
        ///<param name='reverseBits'> specify true if the instance should reverse data bits. </param>
        ///<remarks>
        ///  <para>In the CRC-32 used by BZip2, the bits are reversed. Therefore if you
        ///    want a CRC32 with compatibility with BZip2, you should pass true
        ...
        /// </summary>
        /// <remarks>
        ///   <para>Use this when employing a single instance of this class to compute
        ///     multiple, distinct CRCs on multiple, distinct data blocks.</para>
        /// </remarks>
        public void Reset() {
    ...
    ///</summary>
    ///<remarks>
    ///  <para>This class can be used to verify the CRC of a ZipEntry when
    ///    reading from a stream, or to calculate a CRC when writing to a
    ///    stream.  The stream should be used to either read, or write, but
    ///    not both.  If you intermix reads and writes, the results are not
    ///    defined.</para> <para>This class is intended primarily for use internally by the
    ///                      DotNetZip library.</para>
    ///</remarks>
    public class CrcCalculatorStream : Stream, IDisposable {
        ...
        /// </summary>
        /// <remarks>
        ///   <para>Instances returned from this constructor will leave the underlying
        ///     stream open upon Close().  The stream uses the default CRC32
        ///     algorithm, which implies a polynomial of 0xEDB88320.</para>
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        ///   <para>The stream uses the default CRC32 algorithm, which implies a
        ///     polynomial of 0xEDB88320.</para>
        /// </remarks>
        /// <param name="stream"> The underlying stream </param>
        ...
        /// <remarks>
        ///   <para>The stream uses the default CRC32 algorithm, which implies a
        ///     polynomial of 0xEDB88320.</para> <para>Instances returned from this constructor will leave the underlying
        ///                                        stream open upon Close().</para>
        /// </remarks>
        /// <param name="stream"> The underlying stream </param>
        ...
        /// </summary>
        /// <remarks>
        ///   <para>The running total of the CRC is kept as data is written or read
        ///     through the stream.  read this property after all reads or writes to
        ///     get an accurate CRC for the entire stream.</para>
        /// </remarks>
        public Int32 Crc {
            get {
        ...
        /// </summary>
        /// <remarks>
        ///   <para>Set this at any point before calling
        ///     <see cref="Close()" />
        ///     .</para>
        /// </remarks>
