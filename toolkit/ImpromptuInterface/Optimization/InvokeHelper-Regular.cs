namespace CoApp.Toolkit.ImpromptuInterface.Optimization {
    ...
    internal static partial class InvokeHelper {
        ...
        internal static void InvokeSubtractAssignCallSite(object target, string name, object[] args, string[] argNames, Type context, bool staticContext, ref CallSite callSiteIsEvent, ref CallSite callSiteRemove, ref CallSite callSiteGet,
            ref CallSite callSiteSet) {
            if (InvokeIsEventCallSite(target, name, context, ref callSiteIsEvent)) {
