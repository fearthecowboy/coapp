    ...
    public static class Impromptu {
        ...
        static Impromptu() {
            try {
                ...
                ComBinder = new ImpromptuLateLibraryType(
        ...
        /// ///
        /// <example>
        ///   Unit test that exhibits usage <code><![CDATA[
        ...
        ///<example>
        ///  Unit test that exhibits usage: <code>
        ///                                   <![CDATA[
        ...
        ///<returns> The result. </returns>
        ///<example>
        ///  Unit Test that describes usage <code>
        ///                                   <![CDATA[
        ///    var tSetValue = "1";
        ...
        /// <param name="target"> The target. </param>
        /// <param name="name"> The name. </param>
        /// <returns> <c>true</c> if the specified target is event; otherwise, <c>false</c> . </returns>
        ...
        /// <returns> </returns>
        /// <remarks>
        ///   Advanced use only. Use this method for serious custom invocation, otherwise there are other convenience methods such as <see
        ///    cref="InvokeMember"></see> , <see cref="InvokeGet"></see> , <see cref="InvokeSet"></see> and <see
        ///    cref="InvokeMemberAction"></see>
        /// </remarks>
        ...
        /// <returns> </returns>
        /// <example>
        ///   UnitTest That describes usage <code>
        ///                                   <![CDATA[
