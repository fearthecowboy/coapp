    ...
    public static class BuildProxy {
        ...
        private class MethodSigHash {
            ...
            public override bool Equals(object obj) {
                ...
                if (obj.GetType() != typeof (MethodSigHash)) {
                    return false;
                }
        ...
        private static void MakeMethod(ModuleBuilder builder, MethodInfo info, TypeBuilder typeBuilder, Type contextType, bool defaultImp = true) {
            ...
            if (info.DeclaringType.GetCustomAttributes(typeof (UseNamedArgumentAttribute), false).Any() || info.GetCustomAttributes(typeof (UseNamedArgumentAttribute), false).Any()) {
