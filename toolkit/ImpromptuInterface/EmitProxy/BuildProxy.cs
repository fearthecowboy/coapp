...
namespace CoApp.Toolkit.ImpromptuInterface.EmitProxy
{
    ...
    public static class BuildProxy
    {
        ...
        private static void MakeMethod(ModuleBuilder builder,MethodInfo info, TypeBuilder typeBuilder, Type contextType, bool defaultImp =true)
        {
            ...
            if ( info.DeclaringType.GetCustomAttributes(typeof(Dynamic.UseNamedArgumentAttribute), false).Any() ||  info.GetCustomAttributes(typeof(Dynamic.UseNamedArgumentAttribute), false).Any())
            {
