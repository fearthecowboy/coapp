...
namespace CoApp.Toolkit.ImpromptuInterface.EmitProxy {
    ...
    public class TypeHash {
        ...
        public override bool Equals(object obj) {
            ...
            if (obj.GetType() != typeof (TypeHash)) {
                return false;
            }
        ...
        /// <summary>
        ///   Initializes a new instance of the <see cref="TypeHash" /> class. For use when you have must distinguish one type; and the rest aren't strict
        /// </summary>
