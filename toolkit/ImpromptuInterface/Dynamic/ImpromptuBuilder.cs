...
namespace CoApp.Toolkit.ImpromptuInterface.Dynamic {
    ...
    public interface IImpromptuBuilder {
        ...
        /// <summary>
        ///   Generates Object, use by calling with named arguments <code>builder.Object(Prop1:"test",Prop2:"test")</code> returns new object;
        /// </summary>
        dynamic Object { get; }
    ...
    public class ImpromptuBuilder<TObjectProtoType> : ImpromptuObject, IImpromptuBuilder {
        ...
        public class BuilderTrampoline : DynamicObject {
            private ImpromptuBuilder<TObjectProtoType> _buider;
