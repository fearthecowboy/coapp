...
namespace CoApp.Toolkit.Win32 {
    ...
    internal sealed class SafeHGlobalHandle : SafeHandle {
        ...
        /// <returns> A <see cref="SafeHGlobalHandle" /> representing the memory. </returns>
        ...
        /// </summary>
        /// <returns> An invalid <see cref="SafeHGlobalHandle" /> . </returns>
        ...
        /// </summary>
        /// <returns> <see langword="true" /> if the handle is released successfully; otherwise, in the event of a catastrophic failure, <see
        ///    langword="false" /> . In this case, it generates a releaseHandleFailed MDA Managed Debugging Assistant. </returns>
