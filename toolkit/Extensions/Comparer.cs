...
namespace CoApp.Toolkit.Extensions {
    ...
    public class Comparer<T> : IComparer<T> {
        ...
        /// <returns> Value Condition Less than zero <paramref name="x" /> is less than <paramref name="y" /> . Zero <paramref
        ///    name="x" /> equals <paramref name="y" /> . Greater than zero <paramref name="x" /> is greater than <paramref name="y" /> . </returns>
        /// <remarks>
        /// </remarks>
