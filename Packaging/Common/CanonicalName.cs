...
namespace CoApp.Packaging.Common {
    ...
    public class CanonicalName : IComparable, IComparable<CanonicalName>, IEquatable<CanonicalName> {
        ...
        public CanonicalName OtherVersionFilter { get {
        ...
        private static readonly Regex PartialCoappRx = new Regex(@"^(?<name>.*?)?(?<flavor>\[.+\])?(?<v1>-\d{1,5}|-\*)?(?<v2>\.\d{1,5}|\.\*)?(?<v3>\.\d{1,5}|\.\*)?(?<v4>\.\d{1,5}|\.\*)?(<plus>\+)?(?<arch>-{1,2}any|-{1,2}x86|-{1,2}x64|-{1,2}arm|-{1,2}all|-\*)?(?<pkt>-{1,3}[0-9a-f]{16})?$", RegexOptions.IgnoreCase);
