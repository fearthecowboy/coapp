...
namespace CoApp.Packaging.Service.Feeds {
    ...
    /// <summary>
    ///   A package feed represented by a atom XML file This may be a remote URL or a local xml file.
    /// </summary>
    /// <remarks>
    /// </remarks>
    internal class AtomPackageFeed : PackageFeed {
        /// <summary>
        ///   the remote location this feed is coming from. May be null if this file is local to start with
        /// </summary>
        ...
        /// </summary>
        /// <param name="location"> The local file location of the package feed. </param>
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        ///   Initializes a new instance of the <see cref="AtomPackageFeed" /> class. From a remote URI location
        /// </summary>
